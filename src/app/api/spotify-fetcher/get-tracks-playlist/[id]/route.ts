...
export async function GET(
    ...
    //   const url = new URL(req.url);
      ...
      const response = await fetch(
        `https://api.spotify.com/v1/playlists/${id}/tracks?fields=items(track(album(name,release_date,release_date_precision,images),artists(name),name,uri,id,href,popularity))total`,
        {
